...
// ---------------------------------------------------
// For remote station, typically only USE_CAT and USE_AMPDUINO will be enabled to save space
#define USE_CAT             // CAT, subset of Yaesu FT817ND - works with WSJT-X and FLDigi hamlib
#define	USE_AMPDUINO
//#define USE_DISPLAY		// Support for LCD displays
//#define USE_CW		// CW support
